...
from content.site import (BASE_URL, BASE, BRAND, BRAND_MARK, INDEXNOW_KEY, NAV,
...
def render_breadcrumb(crumbs) -> str:
    ...
    parts.append(f'<li><a href="{HOME}">남양주 홈</a></li>')
...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 남양주시 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">경기 남양주시 전지역 방문 관리(출장마사지·홈타이) 예약 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기 남양주시 전지역</span>
      </address>
      <div class="footer-inquiry">
        <a class="footer-cta-btn" href="{TELEGRAM_BUILD}" target="_blank" rel="noopener nofollow">웹사이트 제작문의 ↗</a>
        <a class="footer-cta-btn" href="{TELEGRAM_PARTNER}" target="_blank" rel="noopener nofollow">제휴문의 ↗</a>
      </div>
    </div>
    <nav class="footer-col" aria-label="지역 안내">
      <p class="footer-title">지역·생활권</p>
      <ul>
        <li><a href="{HOME}#areas">지역별 안내</a></li>
        <li><a href="{HOME}station/">역세권 안내</a></li>
        <li><a href="{HOME}area/">생활권 안내</a></li>
        <li><a href="{HOME}dasan-dong/">다산동</a></li>
        <li><a href="{HOME}byeollae-dong/">별내동</a></li>
      </ul>
    </nav>
    <nav class="footer-col" aria-label="이용 안내">
      <p class="footer-title">이용 안내</p>
      <ul>
        <li><a href="{HOME}reservation/">예약 안내</a></li>
        <li><a href="{HOME}checklist/">이용 전 확인사항</a></li>
        <li><a href="{HOME}hometai-guide/">홈타이 이용 가이드</a></li>
        <li><a href="{HOME}support/">고객센터</a></li>
        <li><a href="{HOME}support/#faq">자주 묻는 질문</a></li>
      </ul>
    </nav>
    <nav class="footer-col" aria-label="정책 및 기준">
      <p class="footer-title">정책</p>
      <ul>
        <li><a href="{HOME}about/">사이트 소개</a></li>
        <li><a href="{HOME}privacy/">개인정보 처리방침</a></li>
        <li><a href="{HOME}terms/">이용약관</a></li>
        <li><a href="{HOME}checklist/#prohibited">불법·선정적 서비스 불가</a></li>
        <li><a href="{HOME}checklist/#privacy">개인정보 처리 기준</a></li>
      </ul>
    </nav>
  </div>
...
def build() -> None:
    ...
    for page in PAGES:
        path = page["path"]  # "" 또는 "dasan-dong/" 형태
    ...
    with open(os.path.join(ROOT, "rss.xml"), "w", encoding="utf-8") as f:
        f.write(
            ...
            "  <channel>\n"
            f"    <title>{html.escape(BRAND)} — 남양주 출장마사지·홈타이 안내</title>\n"
            f"    <link>{base}/</link>\n"
            f'    <atom:link href="{base}/rss.xml" rel="self" type="application/rss+xml" />\n'
            "    <description>경기 남양주시 전지역 방문 관리 지역·역세권·생활권 안내</description>\n"
    ...
    # IndexNow 키 파일 — 배포 후 이 URL이 키 문자열을 그대로 반환해야 통보가 검증된다.
